  ...
  return (
    ...
    >
      <SwitchPrimitives.Thumb
        ...
        className={cn(
          "bg-background dark:data-[state=unchecked]:bg-foreground dark:data-[state=checked]:bg-primary-foreground data-[state=checked]:translate-x-[calc(100%-2px)] dark:data-[state=unchecked]:translate-x-0 data-[state=unchecked]:translate-x-0 pointer-events-none block size-4 rounded-full ring-0 transition-transform translate-x-[2px]",
        )}
      />
    </SwitchPrimitives.Root>
  );
